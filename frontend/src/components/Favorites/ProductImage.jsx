...
function ProductImage({
  ...
  return size == "lg" ? (
    <div className="top mb-2  md:max-w-[600px] md:w-[600px] md:h-[380px] overflow-hidden">
    ...
    >
      <img src={src} alt={alt} className="w-full h-full object-cover" onClick={()=>props.onClick(src)}/>
