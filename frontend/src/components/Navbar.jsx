    ...
    <div className="nav-bar flex flex-wrap justify-between pt-2 border-b pb-2 px-2 md:px-14 sticky top-0 bg-white z-10">
      ...
      {isAuthorized && (
        <div className="right flex gap-6 items-center">
          <a
            ...
            className="p-1 px-3.5 bg-transparent text-cyan-800 font-medium border border-cyan-600 rounded-md hover:text-white hover:bg-cyan-600 duration-150"
          >
            Post
          </a>
          ...
          <div className="avatar flex gap-2 items-center">
            <a href={`/profile/${userInfo && userInfo.id}`}>
              <UserProfile
      ...
      {!isAuthorized && (
        <button
          ...
          className="text-white font-medium rounded-md hover:bg-cyan-600/90 bg-cyan-600 login-btn px-4 py-1"
        >
          Login
        </button>
      )}
